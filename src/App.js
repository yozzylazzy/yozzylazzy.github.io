...
function App() {
  ...
  const [currentMode, setCurrentMode] = useState(prefersDarkMode ? 'dark' : 'light');
  ...
  const theme = useMemo(
    () => createTheme({ palette: { mode: currentMode } }), [currentMode],
  );
                  ...
                  <Box sx={{
                    ...
                    <div
                      style={{
                        ...
                        width: '100%',
                        height: '100%',
                        background: `linear-gradient(to top, ${theme.palette.background.default}, rgba(24,7,51, 0.7),rgba(24,7,51, 0.6),rgba(24,7,51, 0.5))`,
                      }}
                    ></div>
                    <Parallax speed={10}>
